    ...
    val menuItems = mapOf(
            ...
            "chili" to
                    MenuItem(
                            ...
                            description = "Black beans, read beans, kidney beans, slow cooked, topped with onion",
                            price = 4.00,
                            type = ItemType.ENTREE
                    ),
            "pasta" to
            ...
            "skillet" to
                    MenuItem(
                            ...
                            description = "Seasonal vegetables, black beans, house spice blend, service with avocado " +
            ...
            "pickles" to
                    MenuItem(
                            ...
                            description = "Picked cucumbers and carrots, made in house",
                            price = 0.50,
                            type = ItemType.ACCOMPANIMENT
                    )
    )
